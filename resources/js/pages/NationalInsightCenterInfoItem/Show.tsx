...
export default function Show({ item }: ShowProps) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        },
        {
            ...
            href: nationalInsightCenterInfo?.id
                            ...
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                <div className="space-y-2">
                                    <Label className="text-sm font-medium text-gray-600 dark:text-gray-400">
                                        {t('national_insight_center_info_item.show.title_label')}
                                    </Label>
                                ...
                                <div className="space-y-2">
                                    <Label className="text-sm font-medium text-gray-600 dark:text-gray-400">
                                        {t('national_insight_center_info_item.show.registration_number')}
                                    </Label>
                                ...
                                <div className="space-y-2">
                                    <Label className="text-sm font-medium text-gray-600 dark:text-gray-400">
                                        {t('national_insight_center_info_item.show.status')}
                                    </Label>
                                    <Badge
                                    ...
                                    >
                                        {nationalInsightCenterInfo?.confirmed ? (
                                            <>
                                                <CheckCircle className="mr-1 h-4 w-4" /> {t('national_insight_center_info_item.show.confirmed')}
                                            </>
                                        ) : (
                                            <>
                                                <Clock className="mr-1 h-4 w-4" /> {t('national_insight_center_info_item.show.pending')}
                                            </>
                                        )}
                                    </Badge>
                                </div>
                                ...
                                <div className="space-y-2">
                                    <Label className="text-sm font-medium text-gray-600 dark:text-gray-400">
                                        {t('national_insight_center_info_item.show.date')}
                                    </Label>
                                ...
                                {infoCategory && (
                                    <div className="space-y-2">
                                        <Label className="text-sm font-medium text-gray-600 dark:text-gray-400">
                                            {t('national_insight_center_info_item.show.info_category')}
                                        </Label>
                                        <p className="text-lg font-semibold text-gray-900 dark:text-white">
                                            {infoCategory.name || infoCategory.label || '-'}
                                        </p>
                                    </div>
                                )}
                                ...
                                {item.province && (
                                    <div className="space-y-2">
                                        <Label className="text-sm font-medium text-gray-600 dark:text-gray-400">
                                            {t('national_insight_center_info_item.show.province')}
                                        </Label>
                                        <p className="text-lg font-semibold text-gray-900 dark:text-white">
                                            {item.province.name || item.province.label || '-'}
                                        </p>
                                    </div>
                                )}
                                ...
                                {item.district && (
                                    <div className="space-y-2">
                                        <Label className="text-sm font-medium text-gray-600 dark:text-gray-400">
                                            {t('national_insight_center_info_item.show.district')}
                                        </Label>
                                        <p className="text-lg font-semibold text-gray-900 dark:text-white">
                                            {item.district.name || item.district.label || '-'}
                                        </p>
                                    </div>
                                )}
                            </div>
                    ...
                    <Card className="overflow-hidden border-0 bg-gradient-to-bl from-white to-purple-50/30 shadow-2xl dark:from-gray-800 dark:to-purple-900/20">
                        ...
                        <CardContent className="space-y-6 p-6">
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                ...
                                <div className="space-y-2">
                                    <Label className="text-sm font-medium text-gray-600 dark:text-gray-400">
                                        {t('national_insight_center_info_item.show.updated_at')}
                                    </Label>
                                ...
                                {item.creator && (
                                    <>
                                        <div className="space-y-2">
                                            <Label className="text-sm font-medium text-gray-600 dark:text-gray-400">
                                                {t('national_insight_center_info_item.show.created_by')}
                                            </Label>
                                            <p className="text-lg font-semibold text-gray-900 dark:text-white">
                                                {item.creator?.name || t('national_insight_center_info_item.unknown')}
                                            </p>
                                        </div>
                                        {item.creator?.email && (
                                            <div className="space-y-2">
                                                <Label className="text-sm font-medium text-gray-600 dark:text-gray-400">
                                                    {t('national_insight_center_info_item.show.creator_email')}
                                                </Label>
                                        ...
                                        {item.creator?.department && (
                                            <div className="space-y-2">
                                                <Label className="text-sm font-medium text-gray-600 dark:text-gray-400">
                                                    {t('national_insight_center_info_item.show.creator_department')}
                                                </Label>
