          ...
          <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div className="p-6 text-gray-900">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-semibold">Edit Role: {role.name}</h2>
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-6">
                  ...
                  />
                  {isAdminRole && (
                    <p className="text-sm text-amber-600 mt-1">The admin role name cannot be changed.</p>
                  )}
                  {errors.name && (
                ...
                <div className="mb-6">
                  ...
                  {isAdminRole && (
                    <p className="text-sm text-amber-600 mt-1">The admin role always has all permissions.</p>
                  )}
