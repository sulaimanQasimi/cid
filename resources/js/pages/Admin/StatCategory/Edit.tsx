...
export default function Edit({ category }: EditProps) {
  ...
  const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
      title: 'Edit',
      href: route('stat-categories.edit', category.id),
    },
  ];

  const submit: FormEventHandler = (e) => {
    e.preventDefault();
    put(route('stat-categories.update', category.id));
  };
    ...
    <AppLayout breadcrumbs={breadcrumbs}>
      ...
      <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
        <PageHeader
          ...
          description="Update the details of this statistical category"
          actions={
        ...
        <form onSubmit={submit}>
          <Card>
            ...
            <CardFooter className="flex justify-end space-x-2">
              <Button variant="outline" asChild>
                <Link href={route('stat-categories.show', category.id)}>Cancel</Link>
              </Button>
